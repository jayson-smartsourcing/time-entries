...
@section('content')
     ...
     <div class="container" style="font-family:Nunito">
        ...
        <div class="col border rounded border-info bg-white col-md-6 offset-md-3">
            ...
            <!-- Success and Error Messages -->
                <div class="alert alert-success col-md-12  hidden" id="tx-success-msg" role="alert" style=" text-align:center" >
                    Refresh Successful
                ...
                <div class="alert alert-danger col-md-12  hidden" id="tx-error-msg" role="alert" style=" text-align:center">
                    Incorrect API Key
                    <button type="button" class="close" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
