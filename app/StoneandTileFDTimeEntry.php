...
class StoneandTileFDTimeEntry extends Model
{
    protected $table = 'stone_and_tile_fd_time_entries_v2';
    protected $fillable = [
        'ticket_id',
        'agent' ,
        'charge_type',
    ...
    public function bulkInsert($data){
        return DB::table('stone_and_tile_fd_time_entries_v2')->insert($data);
    }
