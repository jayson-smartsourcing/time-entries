...
class BellePropertyFDTimeEntry extends Model
{
    protected $table = 'belle_property_fd_time_entries_v2';
    protected $fillable = [
        'ticket_id',
        'agent' ,
        'charge_type',
    ...
    public function bulkInsert($data){
        return DB::table('belle_property_fd_time_entries_v2')->insert($data);
    }
