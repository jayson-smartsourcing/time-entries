...
class WhiteLabelFDTimeEntryV3 extends Model
{
    protected $table = 'white_label_fd_time_entries_v3';
    protected $fillable = [
        'billable',
        'note',
        'id',
    ...
    public function bulkInsert($data){
        return DB::table('white_label_fd_time_entries_v3')->insert($data);
    }
    ...
    public function bulkUpdateByNewInsert() {
        return DB::table('white_label_fd_time_entries_v3')->where('is_latest', '=', '1')->update(array('is_latest' => 0));
    }
}
