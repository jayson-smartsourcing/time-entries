...
class SmartsourcingFSTimeEntry extends Model
{
    protected $table = 'smartsourcing_fs_time_entries_v2';
    protected $fillable = [
        'ticket_id',
        'agent' ,
        'charge_type',
    ...
    public function bulkInsert($data){
        return DB::table('smartsourcing_fs_time_entries_v2')->insert($data);
    }
