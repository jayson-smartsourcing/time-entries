...
class NicholsCrowderFDTimeEntry extends Model
{
    protected $table = 'nichols_crowder_fd_time_entries_v2';
    protected $fillable = [
        'ticket_id',
        'agent' ,
        'charge_type',
    ...
    public function bulkInsert($data){
        return DB::table('nichols_crowder_fd_time_entries_v2')->insert($data);
    }
