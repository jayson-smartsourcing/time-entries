...
use App\HennessyFDGroup as HennessyFDGroup;
use App\HennessyFDCompany as HennessyFDCompany;
use App\HennessyFDAgent as HennessyFDAgent;
use App\HennessyFDContact as HennessyFDContact;
use App\HennessyFDTicket as HennessyFDTicket;
use App\HennessyFDTimeEntryV3 as HennessyFDTimeEntryV3;

class HennessyFDController extends Controller
{
    public function __construct(
        Guzzle $guzzle,
        BPNotFoundId  $bp_not_found,
        EmployeeRef $employee_ref,
        HennessyFDGroup $hennessy_fd_group,
        HennessyFDCompany $hennessy_fd_company,
        HennessyFDAgent $hennessy_fd_agent,
        HennessyFDContact $hennessy_fd_contact,
        HennessyFDTicket $hennessy_fd_ticket,
        HennessyFDTimeEntryV3 $hennessy_fd_time_entry 
    )
    {  
        $this->guzzle = $guzzle;
        $this->bp_not_found = $bp_not_found;
        $this->employee_ref = $employee_ref;
        $this->hennessy_fd_group = $hennessy_fd_group;
        $this->hennessy_fd_company = $hennessy_fd_company;
        $this->hennessy_fd_agent = $hennessy_fd_agent;
        $this->hennessy_fd_contact = $hennessy_fd_contact;
        $this->hennessy_fd_ticket = $hennessy_fd_ticket;
        $this->hennessy_fd_time_entry = $hennessy_fd_time_entry;
    }
    ...
    public function getAllGroups() {
        ...
        $this->hennessy_fd_group->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->hennessy_fd_group->bulkInsert($final_data);
            } 
    ...
    public function getAllCompanies() {
        ...
        $this->hennessy_fd_company->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->hennessy_fd_company->bulkInsert($final_data);
            } 
    ...
    public function getAllAgents(){
        ...
        $this->hennessy_fd_agent->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->hennessy_fd_agent->bulkInsert($final_data);
            } 
    ...
    public function getAllContacts(){
        ...
        $this->hennessy_fd_contact->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->hennessy_fd_contact->bulkInsert($final_data);
            } 
    ...
    public function getAllTickets(){
        ...
        $this->hennessy_fd_ticket->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    $now = Carbon::now();
                    $group = $this->hennessy_fd_group->getDataById($value->group_id);
                ...
                $this->hennessy_fd_ticket->bulkInsert($final_data);
    ...
    public function getLatestTicketExport() {
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->hennessy_fd_ticket->bulkDeleteByTicketExportId($ids);
                $this->hennessy_fd_ticket->bulkInsert($final_data);
                if(count($not_found) > 0) {
                    $this->bp_not_found->bulkInsert($not_found);
                }
    ...
    public function getAllTicketsV2(){
        ...
        $this->hennessy_fd_ticket->updateAllFdTickets("hennessy_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function getLatestTicketExportV2() {
        ...
        $this->hennessy_fd_ticket->updateLatestFdTickets("hennessy_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function updateAll() {
        ...
        $this->hennessy_fd_contact->addAgentsToContacts("hennessy_fd");
        $this->hennessy_fd_agent->deleteDuplicates("hennessy_fd_agents");
        $this->hennessy_fd_contact->deleteDuplicates("hennessy_fd_contacts");
        $this->hennessy_fd_company->deleteDuplicates("hennessy_fd_companies");
        $this->hennessy_fd_group->deleteDuplicates("hennessy_fd_groups");
    ...
    public function getLatestTimeEntriesV3() {
            ...
            if(count($body) != 0) {
                ...
                foreach($time_entry_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->hennessy_fd_time_entry->bulkDeleteById($ids);
                        $this->hennessy_fd_time_entry->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    }
        ...
        //die;
        $this->hennessy_fd_time_entry->bulkDeletePreviousMonth($date_after,$date_on_or_before);
        $this->hennessy_fd_time_entry->bulkUpdateByNewInsert();
        return response()->json(['success'=> true], 200);
    }
