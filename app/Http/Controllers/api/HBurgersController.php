...
use App\HBurgersFDGroup as HBurgersFDGroup;
use App\HBurgersFDCompany as HBurgersFDCompany;
...
class HBurgersController extends Controller
{
    public function __construct(
        ...
        HBurgersFDGroup $hburgers_fd_group,
        HBurgersFDCompany $hburgers_fd_company,
    ...
    {  
        ...
        $this->hburgers_fd_group = $hburgers_fd_group;
    ...
    public function getAllGroups() {
        ...
        $data = config('constants.hburgers_fd');
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->hburgers_fd_group->bulkInsert($final_data);
            } 
    ...
    public function getAllCompanies() {
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->hburgers_fd_company->bulkInsert($final_data);
            } 
    ...
    public function getAllAgents(){
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->hburgers_fd_agent->bulkInsert($final_data);
            } 
    ...
    public function getAllContacts(){
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->hburgers_fd_contact->bulkInsert($final_data);
            } 
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    $now = Carbon::now();
                    $group = $this->hburgers_fd_group->getDataById($value->group_id);
    ...
    public function getLatestTimeEntriesV3() {
            ...
            if(count($body) != 0) {
                ...
                foreach($time_entry_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->hburgers_fd_time_entry->bulkDeleteById($ids);
                        $this->hburgers_fd_time_entry->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    }
        ...
        //die;
        $this->hburgers_fd_time_entry->bulkDeletePreviousMonth($date_after,$date_on_or_before);
        $this->hburgers_fd_time_entry->bulkUpdateByNewInsert();
        return response()->json(['success'=> true], 200);
    }
