...
use App\BeerCartelFDGroup as BeerCartelFDGroup;
use App\BeerCartelFDCompany as BeerCartelFDCompany;
use App\BeerCartelFDAgent as BeerCartelFDAgent;
use App\BeerCartelFDContact as BeerCartelFDContact;
use App\BeerCartelFDTicket as BeerCartelFDTicket;
use App\BeerCartelFDTimeEntryV2 as BeerCartelFDTimeEntryV2;


class BeerCartelFDController extends Controller
{
    public function __construct(
        Guzzle $guzzle,
        BPNotFoundId  $bp_not_found,
        EmployeeRef $employee_ref,
        BeerCartelFDGroup $beer_cartel_group,
        BeerCartelFDCompany $beer_cartel_company,
        BeerCartelFDAgent $beer_cartel_agent,
        BeerCartelFDContact $beer_cartel_contact,
        BeerCartelFDTicket $beer_cartel_ticket,
        BeerCartelFDTimeEntryV2 $beer_cartel_time_entry
    )
    {
        $this->guzzle = $guzzle;
        $this->bp_not_found = $bp_not_found;
        $this->employee_ref = $employee_ref;
        $this->beer_cartel_group = $beer_cartel_group;
        $this->beer_cartel_company = $beer_cartel_company;
        $this->beer_cartel_agent = $beer_cartel_agent;
        $this->beer_cartel_contact = $beer_cartel_contact;
        $this->beer_cartel_ticket = $beer_cartel_ticket;
        $this->beer_cartel_time_entry = $beer_cartel_time_entry;
    }

    public function getAllGroups() {
        $client = new $this->guzzle();
        $data = config('constants.beer_cartel');
        ...
        $this->beer_cartel_group->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->beer_cartel_group->bulkInsert($final_data);
            } 
    ...
    public function getAllCompanies() {
        ...
        $this->beer_cartel_company->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->beer_cartel_company->bulkInsert($final_data);
            } 
    ...
    public function getAllAgents(){
        ...
        $this->beer_cartel_agent->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->beer_cartel_agent->bulkInsert($final_data);
            } 

        }
        $this->beer_cartel_contact->addAgentsToContacts("beer_cartel_fd");
    ...
    public function getAllContacts(){
        ...
        $x = 1;
        $y = 3;
        $this->beer_cartel_contact->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->beer_cartel_contact->bulkInsert($final_data);
            } 
    ...
    public function getAllTicketsV2(){
        ...
        // $two_days_ago = Carbon::now()->subDays(30)->format('Y-m-d');
        ...
        $this->beer_cartel_ticket->truncateTable();
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        $this->beer_cartel_ticket->bulkInsert($final_data);
                        $final_data = [];
                    } 
        ...
        $this->beer_cartel_ticket->updateAllFdTickets("beer_cartel_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function getLatestTicketExportV2() {
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->beer_cartel_ticket->bulkDeleteByTicketExportId($ids);
                        $this->beer_cartel_ticket->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    } 
        ...
        $this->beer_cartel_ticket->updateLatestFdTickets("beer_cartel_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function updateAll() {
        ...
        $this->beer_cartel_contact->addAgentsToContacts("beer_cartel_fd");
        $this->beer_cartel_agent->deleteDuplicates("beer_cartel_fd_agents");
        $this->beer_cartel_contact->deleteDuplicates("beer_cartel_fd_contacts");
        $this->beer_cartel_company->deleteDuplicates("beer_cartel_fd_companies");
        $this->beer_cartel_group->deleteDuplicates("beer_cartel_fd_groups");
            ...
            if(count($body) != 0) {
                ...
                foreach($time_entry_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->beer_cartel_time_entry->bulkDeleteById($ids);
                        $this->beer_cartel_time_entry->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    } 
