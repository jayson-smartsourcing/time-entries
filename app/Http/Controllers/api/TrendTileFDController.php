...
use App\TrendTileFDGroup as TrendTileFDGroup;
use App\TrendTileFDCompany as TrendTileFDCompany;
use App\TrendTileFDAgent as TrendTileFDAgent;
use App\TrendTileFDContact as TrendTileFDContact;
use App\TrendTileFDTicket as TrendTileFDTicket;
use App\TrendTileFDTimeEntryV3 as TrendTileFDTimeEntryV3;


class TrendTileFDController extends Controller
{
    public function __construct(
        Guzzle $guzzle,
        BPNotFoundId  $bp_not_found,
        EmployeeRef $employee_ref,
        TrendTileFDGroup $trendtile_group,
        TrendTileFDCompany $trendtile_company,
        TrendTileFDAgent $trendtile_agent,
        TrendTileFDContact $trendtile_contact,
        TrendTileFDTicket $trendtile_ticket,
        TrendTileFDTimeEntryV3 $trendtile_time_entry
    )
    {
        $this->guzzle = $guzzle;
        $this->bp_not_found = $bp_not_found;
        $this->employee_ref = $employee_ref;
        $this->trendtile_group = $trendtile_group;
        $this->trendtile_company = $trendtile_company;
        $this->trendtile_agent = $trendtile_agent;
        $this->trendtile_contact = $trendtile_contact;
        $this->trendtile_ticket = $trendtile_ticket;
        $this->trendtile_time_entry = $trendtile_time_entry;
    }

    public function getAllGroups() {
        $client = new $this->guzzle();
        $data = config('constants.trendtile_fd');
        ...
        $this->trendtile_group->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->trendtile_group->bulkInsert($final_data);
            } 
    ...
    public function getAllCompanies() {
        ...
        $this->trendtile_company->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->trendtile_company->bulkInsert($final_data);
            } 
    ...
    public function getAllAgents(){
        ...
        $this->trendtile_agent->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->trendtile_agent->bulkInsert($final_data);
            } 
    ...
    public function getAllContacts(){
        ...
        $x = 1;
        $y = 3;
        $this->trendtile_contact->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->trendtile_contact->bulkInsert($final_data);
            } 
    ...
    public function getAllTicketsV2(){
        ...
        $this->trendtile_ticket->truncateTable();
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        $this->trendtile_ticket->bulkInsert($final_data);
                        $final_data = [];
                    } 
        ...
        $this->trendtile_ticket->updateAllFdTickets("trendtile_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function getLatestTicketExportV2() {
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->trendtile_ticket->bulkDeleteByTicketExportId($ids);
                        $this->trendtile_ticket->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    } 
        ...
        $this->trendtile_ticket->updateLatestFdTickets("trendtile_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function updateAll() {
        ...
        $this->trendtile_contact->addAgentsToContacts("trendtile_fd");
        $this->trendtile_agent->deleteDuplicates("trendtile_fd_agents");
        $this->trendtile_contact->deleteDuplicates("trendtile_fd_contacts");
        $this->trendtile_company->deleteDuplicates("trendtile_fd_companies");
        $this->trendtile_group->deleteDuplicates("trendtile_fd_groups");
    ...
    public function getLatestTimeEntriesV3() {
            ...
            if(count($body) != 0) {
                ...
                foreach($time_entry_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->trendtile_time_entry->bulkDeleteById($ids);
                        $this->trendtile_time_entry->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    }
        ...
        //die;
        $this->trendtile_time_entry->bulkDeletePreviousMonth($date_after,$date_on_or_before);
        $this->trendtile_time_entry->bulkUpdateByNewInsert();
        return response()->json(['success'=> true], 200);
    }
