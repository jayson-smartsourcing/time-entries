...
use App\UrbanAnglesFDGroup as UrbanAnglesFDGroup;
use App\UrbanAnglesFDCompany as UrbanAnglesFDCompany;
use App\UrbanAnglesFDAgent as UrbanAnglesFDAgent;
use App\UrbanAnglesFDContact as UrbanAnglesFDContact;
use App\UrbanAnglesFDTicket as UrbanAnglesFDTicket;
use App\UrbanAnglesFDTimeEntryV3 as UrbanAnglesFDTimeEntryV3;

class UrbanAnglesFDController extends Controller
{
    public function __construct(
      Guzzle $guzzle,
      BPNotFoundId  $bp_not_found,
      EmployeeRef $employee_ref,
      UrbanAnglesFDGroup $urban_angles_group,
      UrbanAnglesFDCompany $urban_angles_company,
      UrbanAnglesFDAgent $urban_angles_agent,
      UrbanAnglesFDContact $urban_angles_contact,
      UrbanAnglesFDTicket $urban_angles_ticket,
      UrbanAnglesFDTimeEntryV3 $urban_angles_time_entry
  ...
  )
  {
      ...
      $this->urban_angles_group = $urban_angles_group;
      $this->urban_angles_company = $urban_angles_company;
      $this->urban_angles_agent = $urban_angles_agent;
      $this->urban_angles_contact = $urban_angles_contact;
      $this->urban_angles_ticket = $urban_angles_ticket;
      $this->urban_angles_time_entry = $urban_angles_time_entry;
  }

    public function getAllGroups() {
        $client = new $this->guzzle();
        $data = config('constants.urban_angles_fd');
        ...
        $this->urban_angles_group->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->urban_angles_group->bulkInsert($final_data);
            } 
    ...
    public function getAllCompanies() {
        ...
        $this->urban_angles_company->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->urban_angles_company->bulkInsert($final_data);
            } 
    ...
    public function getAllAgents(){
        ...
        $this->urban_angles_agent->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->urban_angles_agent->bulkInsert($final_data);
            } 
    ...
    public function getAllContacts(){
        ...
        $x = 1;
        $y = 3;
        $this->urban_angles_contact->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->urban_angles_contact->bulkInsert($final_data);
            } 
    ...
    public function getAllTicketsV2(){
        ...
        $this->urban_angles_ticket->truncateTable();
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        $this->urban_angles_ticket->bulkInsert($final_data);
                        $final_data = [];
                    } 
        ...
        $this->urban_angles_ticket->updateAllFdTickets("urban_angles_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function getLatestTicketExportV2() {
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->urban_angles_ticket->bulkDeleteByTicketExportId($ids);
                        $this->urban_angles_ticket->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    } 
        ...
        $this->urban_angles_ticket->updateLatestFdTickets("urban_angles_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function getLatestTimeEntriesV3() {
            ...
            if(count($body) != 0) {
                ...
                foreach($time_entry_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->urban_angles_time_entry->bulkDeleteById($ids);
                        $this->urban_angles_time_entry->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    }
        ...
        //die;
        $this->urban_angles_time_entry->bulkDeletePreviousMonth($date_after,$date_on_or_before);
        $this->urban_angles_time_entry->bulkUpdateByNewInsert();
        return response()->json(['success'=> true], 200);
    }
