...
use App\CameronFDGroup as CameronFDGroup;
use App\CameronFDCompany as CameronFDCompany;
use App\CameronFDAgent as CameronFDAgent;
use App\CameronFDContact as CameronFDContact;
use App\CameronFDTicket as CameronFDTicket;
use App\CameronFDTimeEntryV3 as CameronFDTimeEntryV3;

class CameronFDController extends Controller
{   
    public function __construct(
        Guzzle $guzzle,
        BPNotFoundId  $bp_not_found,
        EmployeeRef $employee_ref,
        CameronFDGroup $cameron_fd_group,
        CameronFDCompany $cameron_fd_company,
        CameronFDAgent $cameron_fd_agent,
        CameronFDContact $cameron_fd_contact,
        CameronFDTicket $cameron_fd_ticket,
        CameronFDTimeEntryV3 $cameron_fd_time_entry
    )
    {  
        $this->guzzle = $guzzle;
        $this->bp_not_found = $bp_not_found;
        $this->employee_ref = $employee_ref;
        $this->cameron_fd_group = $cameron_fd_group;
        $this->cameron_fd_company = $cameron_fd_company;
        $this->cameron_fd_agent = $cameron_fd_agent; 
        $this->cameron_fd_contact = $cameron_fd_contact;
        $this->cameron_fd_ticket = $cameron_fd_ticket;
        $this->cameron_fd_time_entry = $cameron_fd_time_entry;
    }
    
    public function getAllGroups() {
        $client = new $this->guzzle();
        $data = config('constants.cameron_fd');
        ...
        $this->cameron_fd_group->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->cameron_fd_group->bulkInsert($final_data);
            } 
    ...
    public function getAllCompanies() {
        ...
        $this->cameron_fd_company->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->cameron_fd_company->bulkInsert($final_data);
            } 
    ...
    public function getAllAgents(){
        ...
        $this->cameron_fd_agent->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->cameron_fd_agent->bulkInsert($final_data);
            } 
    ...
    public function getAllContacts(){
        ...
        $x = 1;
        $y = 3;
        $this->cameron_fd_contact->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->cameron_fd_contact->bulkInsert($final_data);
            } 
    ...
    public function getAllTickets(){
        ...
        $this->cameron_fd_ticket->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    $now = Carbon::now();
                    $group = $this->cameron_fd_group->getDataById($value->group_id);
                ...
                $this->cameron_fd_ticket->bulkInsert($final_data);
    ...
    public function getLatestTicketExport() {
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->cameron_fd_ticket->bulkDeleteByTicketExportId($ids);
                $this->cameron_fd_ticket->bulkInsert($final_data);
                if(count($not_found) > 0) {
                    $this->bp_not_found->bulkInsert($not_found);
                }
    ...
    public function getAllTicketsV2(){
        ...
        $this->cameron_fd_ticket->updateAllFdTickets("cameron_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function getLatestTicketExportV2() {
        ...
        $this->cameron_fd_ticket->updateLatestFdTickets("cameron_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function updateAll() {
        ...
        $this->cameron_fd_agent->deleteDuplicates("cameron_fd_agents");
        $this->cameron_fd_contact->addAgentsToContacts("cameron_fd");
        $this->cameron_fd_contact->deleteDuplicates("cameron_fd_contacts");
        $this->cameron_fd_company->deleteDuplicates("cameron_fd_companies");
        $this->cameron_fd_group->deleteDuplicates("cameron_fd_groups");
    ...
    public function getLatestTimeEntriesV3() {
            ...
            if(count($body) != 0) {
                ...
                foreach($time_entry_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->cameron_fd_time_entry->bulkDeleteById($ids);
                        $this->cameron_fd_time_entry->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    }
        ...
        //die;
        $this->cameron_fd_time_entry->bulkDeletePreviousMonth($date_after,$date_on_or_before);
        $this->cameron_fd_time_entry->bulkUpdateByNewInsert();
        return response()->json(['success'=> true], 200);
    }
}
