...
use App\DSFDGroup as DSFDGroup;
use App\DSFDCompany as DSFDCompany;
use App\DSFDAgent as DSFDAgent;
use App\DSFDContact as DSFDContact;
use App\DSFDTicket as DSFDTicket;
...
class DSFDController extends Controller
{
    public function __construct(
        ...
        DSFDGroup $ds_group,
        DSFDCompany $ds_company,
        DSFDAgent $ds_agent,
        DSFDContact $ds_contact,
        DSFDTicket $ds_ticket
    ...
    {  
        ...
        $this->ds_company = $ds_company;
        $this->ds_agent = $ds_agent;
        $this->ds_contact = $ds_contact;
        $this->ds_ticket = $ds_ticket;
    ...
    public function getAllGroups() {
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->ds_group->bulkInsert($final_data);
            } 
    ...
    public function getAllCompanies() {
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->ds_company->bulkInsert($final_data);
            } 
    ...
    public function getAllAgents(){
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->ds_agent->bulkInsert($final_data);
            } 
    ...
    public function getAllContacts(){
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->ds_contact->bulkInsert($final_data);
            } 
    ...
    public function getAllTicketsV2(){
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        $this->ds_ticket->bulkInsert($final_data);
                        $final_data = [];
                    } 
        ...
        $this->ds_ticket->updateAllFdTickets("ds_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function getLatestTicketExportV2() {
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->ds_ticket->bulkDeleteByTicketExportId($ids);
                        $this->ds_ticket->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    } 
        ...
        $this->ds_ticket->updateLatestFdTickets("ds_fd");
        return response()->json(['success'=> true], 200);
    }
