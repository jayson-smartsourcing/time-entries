...
class JCNFinanceFDController extends Controller
{
    ...
    public function getAllGroups() {
        ...
        $data = config('constants.jcn_finance_fd');
    ...
    public function getLatestTimeEntriesV3() {
        ...
        //die;
        $this->jcn_finance_fd_time_entry->bulkDeletePreviousMonth($date_after,$date_on_or_before);
        $this->jcn_finance_fd_time_entry->bulkUpdateByNewInsert();
        return response()->json(['success'=> true], 200);
    }
}
