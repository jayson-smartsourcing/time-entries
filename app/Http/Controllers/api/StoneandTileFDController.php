...
class StoneandTileFDController extends Controller
{
    ...
    public function getAllGroups() {
        ...
        $data = config('constants.stone_and_tile_fd');
    ...
    public function getLatestTimeEntriesV3() {
        ...
        //die;
        $this->stone_and_tile_time_entry->bulkDeletePreviousMonth($date_after,$date_on_or_before);
        $this->stone_and_tile_time_entry->bulkUpdateByNewInsert();
        return response()->json(['success'=> true], 200);
    }
