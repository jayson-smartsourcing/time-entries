...
use App\SmartsourcingFSGroup as SmartsourcingFSGroup;
use App\SmartsourcingFSDepartment as SmartsourcingFSDepartment;
use App\SmartsourcingFSRequester as SmartsourcingFSRequester;
use App\SmartsourcingFSAgent as SmartsourcingFSAgent;
use App\SmartsourcingFSTicket as SmartsourcingFSTicket;


class SmartsourcingFSController extends Controller
{
    public function __construct(
        Guzzle $guzzle,
        BPNotFoundId  $bp_not_found,
        EmployeeRef $employee_ref,
        SmartsourcingFSGroup $smartsourcing_fs_group,
        SmartsourcingFSDepartment $smartsourcing_fs_department,
        SmartsourcingFSRequester $smartsourcing_fs_requester,
        SmartsourcingFSAgent $smartsourcing_fs_agent,
        SmartsourcingFSTicket $smartsourcing_fs_ticket
    ...
    {  
        ...
        $this->smartsourcing_fs_group = $smartsourcing_fs_group;
        $this->smartsourcing_fs_department = $smartsourcing_fs_department;
        $this->smartsourcing_fs_requester = $smartsourcing_fs_requester;
        $this->smartsourcing_fs_agent = $smartsourcing_fs_agent;
        $this->smartsourcing_fs_ticket = $smartsourcing_fs_ticket;
      
    }

    public function getAllGroups() {
        $client = new $this->guzzle();
        $data = config('constants.smartsourcing_fs');
        ...
        $this->smartsourcing_fs_group->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body->groups) != 0) {
                ...
                $this->smartsourcing_fs_group->bulkInsert($final_data);
            } 
    ...
    public function getAllDepartments() {
        ...
        $this->smartsourcing_fs_department->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body->departments) != 0) {
                ...
                $this->smartsourcing_fs_department->bulkInsert($final_data);
            } 
    ...
    public function getAllRequester() {
        ...
        $x = 1;
        $y = 3;
        $this->smartsourcing_fs_requester->truncateTable();
        for( $i = 1; $i<= $x; $i++ ) {
            $link .= "&page=".$i;
            //call to api
            $response = $client->request('GET', $link, [
            ...
            if(count($body->requesters) != 0) {
                ...
                $this->smartsourcing_fs_requester->bulkInsert($final_data);
            } 
    ...
    public function getAllAgents() {
        ...
        $this->smartsourcing_fs_agent->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body->agents) != 0) {
                ...
                $this->smartsourcing_fs_agent->bulkInsert($final_data);
                return response()->json(['success'=> true], 200);
            } 
        }    
    }
    ...
    public function getAllTicketExport() {
        ...
        $x = 1;
        $y = 3;
        $this->smartsourcing_fs_ticket->truncateTable();
        for( $i = 1; $i<= $x; $i++ ) {
            $link .= "&page=".$i;
            //call to api
            $response = $client->request('GET', $link, [
            ...
            if(count($body->tickets) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    $now = Carbon::now();
                    $group = $this->smartsourcing_fs_group->getDataById($value->group_id);
                    $department = $this->smartsourcing_fs_department->getDataById($value->department_id);
                ...
                $this->smartsourcing_fs_ticket->bulkInsert($final_data);
    ...
    public function getLatestTicketExport() {
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body->tickets) != 0) {
                ...
                $this->smartsourcing_fs_ticket->bulkDeleteByTicketExportId($ids);
                $this->smartsourcing_fs_ticket->bulkInsert($final_data);
                if(count($not_found) > 0) {
                    $this->bp_not_found->bulkInsert($not_found);
                }
    ...
    public function getAllTicketExportV2(){
        ...
        $this->smartsourcing_fs_ticket->updateAllFdTickets("smartsourcing_fs");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function getLatestTicketExportV2() {
        ...
        $this->smartsourcing_fs_ticket->updateLatestFdTickets("smartsourcing_fs");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function updateAll() {
        ...
        $this->smartsourcing_fs_requester->addAgentsToContacts("smartsourcing_fs");
        $this->smartsourcing_fs_agent->deleteDuplicates("smartsourcing_fs_agents");
        $this->smartsourcing_fs_requester->deleteDuplicates("smartsourcing_fs_requesters");
        $this->smartsourcing_fs_department->deleteDuplicates("smartsourcing_fs_departments");
        $this->smartsourcing_fs_group->deleteDuplicates("smartsourcing_fs_groups");
