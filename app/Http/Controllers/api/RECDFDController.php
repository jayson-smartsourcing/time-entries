...
use App\RECDFDGroup as RECDFDGroup;
use App\RECDFDCompany as RECDFDCompany;
use App\RECDFDAgent as RECDFDAgent;
use App\RECDFDContact as RECDFDContact;
use App\RECDFDTicket as RECDFDTicket;



class RECDFDController extends Controller
{
    public function __construct(
        Guzzle $guzzle,
        BPNotFoundId  $bp_not_found,
        EmployeeRef $employee_ref,
        RECDFDGroup $recd_fd_group,
        RECDFDCompany $recd_fd_company,
        RECDFDAgent $recd_fd_agent,
        RECDFDContact $recd_fd_contact,
        RECDFDTicket $recd_fd_ticket
    ...
    {  
        ...
        $this->recd_fd_group = $recd_fd_group;
        $this->recd_fd_company = $recd_fd_company;
        $this->recd_fd_agent = $recd_fd_agent;
        $this->recd_fd_contact = $recd_fd_contact;
        $this->recd_fd_ticket = $recd_fd_ticket;
    }
    ...
    public function getAllGroups() {
        ...
        $this->recd_fd_group->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->recd_fd_group->bulkInsert($final_data);
            } 
    ...
    public function getAllCompanies() {
        ...
        $this->recd_fd_company->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->recd_fd_company->bulkInsert($final_data);
            } 
    ...
    public function getAllAgents(){
        ...
        $this->recd_fd_agent->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->recd_fd_agent->bulkInsert($final_data);
            } 
    ...
    public function getAllTickets(){
        ...
        $this->recd_fd_ticket->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    $now = Carbon::now();
                    $group = $this->recd_fd_group->getDataById($value->group_id);
                ...
                $this->recd_fd_ticket->bulkInsert($final_data);
    ...
    public function getLatestTicketExport() {
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->recd_fd_ticket->bulkDeleteByTicketExportId($ids);
                $this->recd_fd_ticket->bulkInsert($final_data);
                if(count($not_found) > 0) {
                    $this->bp_not_found->bulkInsert($not_found);
                }
    ...
    public function getAllTicketsV2(){
        ...
        $this->recd_fd_ticket->updateAllFdTickets("recd_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function updateAll() {
        ...
        $this->recd_fd_agent->deleteDuplicates("recd_fd_agents");
        $this->recd_fd_contact->deleteDuplicates("recd_fd_contacts");
        $this->recd_fd_company->deleteDuplicates("recd_fd_companies");
        $this->recd_fd_group->deleteDuplicates("recd_fd_groups");
