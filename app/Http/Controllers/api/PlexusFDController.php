...
use App\PlexusFDGroup as PlexusFDGroup;
use App\PlexusFDCompany as PlexusFDCompany;
use App\PlexusFDAgent as PlexusFDAgent;
use App\PlexusFDContact as PlexusFDContact;
use App\PlexusFDTicket as PlexusFDTicket; 
use App\PlexusFDTimeEntryV3 as PlexusFDTimeEntryV3;

class PlexusFDController extends Controller
{
    public function __construct(
        Guzzle $guzzle,
        BPNotFoundId  $bp_not_found,
        EmployeeRef $employee_ref,
        PlexusFDGroup $plexus_fd_group,
        PlexusFDCompany $plexus_fd_company,
        PlexusFDAgent $plexus_fd_agent,
        PlexusFDContact $plexus_fd_contact,
        PlexusFDTicket $plexus_fd_ticket,
        PlexusFDTimeEntryV3 $plexus_fd_time_entry
    )
    {
        $this->guzzle = $guzzle;
        $this->bp_not_found = $bp_not_found;
        $this->employee_ref = $employee_ref;
        $this->plexus_fd_group = $plexus_fd_group;
        $this->plexus_fd_company = $plexus_fd_company;
        $this->plexus_fd_agent = $plexus_fd_agent;
        $this->plexus_fd_contact = $plexus_fd_contact;
        $this->plexus_fd_ticket = $plexus_fd_ticket;
        $this->plexus_fd_time_entry = $plexus_fd_time_entry;
    }
    ...
    public function getAllGroups() {
        ...
        $this->plexus_fd_group->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->plexus_fd_group->bulkInsert($final_data);
            } 
    ...
    public function getAllCompanies() {
        ...
        $this->plexus_fd_company->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->plexus_fd_company->bulkInsert($final_data);
            } 
    ...
    public function getAllAgents(){
        ...
        $this->plexus_fd_agent->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->plexus_fd_agent->bulkInsert($final_data);
            } 

        }
        $this->plexus_fd_contact->addAgentsToContacts("plexus_fd");
    ...
    public function getAllContacts(){
        ...
        $x = 1;
        $y = 3;
        $this->plexus_fd_contact->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->plexus_fd_contact->bulkInsert($final_data);
            } 
    ...
    public function getAllTicketsV2(){
        ...
        $this->plexus_fd_ticket->truncateTable();
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        $this->plexus_fd_ticket->bulkInsert($final_data);
                        $final_data = [];
                    } 
        ...
        $this->plexus_fd_ticket->updateAllFdTickets("plexus_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function getLatestTicketExportV2() {
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->plexus_fd_ticket->bulkDeleteByTicketExportId($ids);
                        $this->plexus_fd_ticket->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    } 
        ...
        $this->plexus_fd_ticket->updateLatestFdTickets("plexus_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function updateAll() {
        ...
        $this->plexus_fd_contact->addAgentsToContacts("plexus_fd");
        $this->plexus_fd_agent->deleteDuplicates("plexus_fd_agents");
        $this->plexus_fd_contact->deleteDuplicates("plexus_fd_contacts");
        $this->plexus_fd_company->deleteDuplicates("plexus_fd_companies");
        $this->plexus_fd_group->deleteDuplicates("plexus_fd_groups");
