...
{   
    ...
    public function getAllGroups() {
        ...
        $data = config('constants.harris_fs');
        ...
        $this->harris_fs_group->truncateTable();
    ...
    public function getAllDepartments() {
        ...
        $this->harris_fs_department->truncateTable();
    ...
    public function getAllRequester() {
        ...
        $this->harris_fs_requester->truncateTable();
    ...
    public function getAllTicketExportV2(){
        ...
        $this->harris_fs_ticket->truncateTable();
        ...
        $this->harris_fs_ticket->updateAllFdTickets("harris_fs");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function getLatestTicketExportV2() {
        ...
        $this->harris_fs_ticket->updateLatestFdTickets("harris_fs");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function updateAll() {
        ...
        $this->harris_fs_agent->deleteDuplicates("harris_fs_agents");
        $this->harris_fs_requester->deleteDuplicates("harris_fs_requesters");
        $this->harris_fs_department->deleteDuplicates("harris_fs_departments");
        $this->harris_fs_group->deleteDuplicates("harris_fs_groups");
