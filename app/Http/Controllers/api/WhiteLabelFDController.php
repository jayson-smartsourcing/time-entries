...
use App\WhiteLabelFDGroup as WhiteLabelFDGroup;
use App\WhiteLabelFDCompany as WhiteLabelFDCompany;
use App\WhiteLabelFDAgent as WhiteLabelFDAgent;
use App\WhiteLabelFDContact as WhiteLabelFDContact;
use App\WhiteLabelFDTicket as WhiteLabelFDTicket;
use App\WhiteLabelFDTimeEntryV3 as WhiteLabelFDTimeEntryV3;


class WhiteLabelFDController extends Controller
{
    public function __construct(
        Guzzle $guzzle,
        BPNotFoundId  $bp_not_found,
        EmployeeRef $employee_ref,
        WhiteLabelFDGroup $white_label_group,
        WhiteLabelFDCompany $white_label_company,
        WhiteLabelFDAgent $white_label_agent,
        WhiteLabelFDContact $white_label_contact,
        WhiteLabelFDTicket $white_label_ticket,
        WhiteLabelFDTimeEntryV3 $white_label_time_entry
    )
    {
        $this->guzzle = $guzzle;
        $this->bp_not_found = $bp_not_found;
        $this->employee_ref = $employee_ref;
        $this->white_label_group = $white_label_group;
        $this->white_label_company = $white_label_company;
        $this->white_label_agent = $white_label_agent;
        $this->white_label_contact = $white_label_contact;
        $this->white_label_ticket = $white_label_ticket;
        $this->white_label_time_entry = $white_label_time_entry;
    }

    public function getAllGroups() {
        $client = new $this->guzzle();
        $data = config('constants.white_label_fd');
        ...
        $this->white_label_group->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->white_label_group->bulkInsert($final_data);
            } 
    ...
    public function getAllCompanies() {
        ...
        $this->white_label_company->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->white_label_company->bulkInsert($final_data);
            } 
    ...
    public function getAllAgents(){
        ...
        $this->white_label_agent->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->white_label_agent->bulkInsert($final_data);
            } 
    ...
    public function getAllContacts(){
        ...
        $x = 1;
        $y = 3;
        $this->white_label_contact->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->white_label_contact->bulkInsert($final_data);
            } 
    ...
    public function getAllTicketsV2(){
        ...
        $this->white_label_ticket->truncateTable();
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        $this->white_label_ticket->bulkInsert($final_data);
                        $final_data = [];
                    } 
        ...
        $this->white_label_ticket->updateAllFdTickets("white_label_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function getLatestTicketExportV2() {
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->white_label_ticket->bulkDeleteByTicketExportId($ids);
                        $this->white_label_ticket->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    } 
        ...
        $this->white_label_ticket->updateLatestFdTickets("white_label_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function getLatestTimeEntriesV3() {
            ...
            if(count($body) != 0) {
                ...
                foreach($time_entry_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->white_label_time_entry->bulkDeleteById($ids);
                        $this->white_label_time_entry->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    }
        ...
        //die;
        $this->white_label_time_entry->bulkDeletePreviousMonth($date_after,$date_on_or_before);
        $this->white_label_time_entry->bulkUpdateByNewInsert();
        return response()->json(['success'=> true], 200);
    }
}
