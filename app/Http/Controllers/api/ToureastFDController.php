...
use App\ToureastFDGroup as ToureastFDGroup;
use App\ToureastFDCompany as ToureastFDCompany;
use App\ToureastFDAgent as ToureastFDAgent;
use App\ToureastFDContact as ToureastFDContact;
use App\ToureastFDTicket as ToureastFDTicket;
use App\ToureastFDTimeEntryV3 as ToureastFDTimeEntryV3;



class ToureastFDController extends Controller
{
    public function __construct(
        Guzzle $guzzle,
        BPNotFoundId  $bp_not_found,
        EmployeeRef $employee_ref,
        ToureastFDGroup $toureast_fd_group,
        ToureastFDCompany $toureast_fd_company,
        ToureastFDAgent $toureast_fd_agent,
        ToureastFDContact $toureast_fd_contact,
        ToureastFDTicket $toureast_fd_ticket,
        ToureastFDTimeEntryV3 $toureast_fd_time_entry  
    )
    {  
        $this->guzzle = $guzzle;
        $this->bp_not_found = $bp_not_found;
        $this->employee_ref = $employee_ref;
        $this->toureast_fd_group = $toureast_fd_group;
        $this->toureast_fd_company = $toureast_fd_company;
        $this->toureast_fd_agent = $toureast_fd_agent;
        $this->toureast_fd_contact = $toureast_fd_contact;
        $this->toureast_fd_ticket = $toureast_fd_ticket;
        $this->toureast_fd_time_entry = $toureast_fd_time_entry;
    }
    ...
    public function getAllGroups() {
        ...
        $this->toureast_fd_group->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->toureast_fd_group->bulkInsert($final_data);
            } 
    ...
    public function getAllCompanies() {
        ...
        $this->toureast_fd_company->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->toureast_fd_company->bulkInsert($final_data);
            } 
    ...
    public function getAllAgents(){
        ...
        $this->toureast_fd_agent->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->toureast_fd_agent->bulkInsert($final_data);
            } 
    ...
    public function getAllTickets(){
        ...
        $this->toureast_fd_ticket->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    $now = Carbon::now();
                    $group = $this->toureast_fd_group->getDataById($value->group_id);
                ...
                $this->toureast_fd_ticket->bulkInsert($final_data);
    ...
    public function getLatestTicketExport() {
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->toureast_fd_ticket->bulkDeleteByTicketExportId($ids);
                $this->toureast_fd_ticket->bulkInsert($final_data);
                if(count($not_found) > 0) {
                    $this->bp_not_found->bulkInsert($not_found);
                }
    ...
    public function getAllTicketsV2(){
        ...
        $this->toureast_fd_ticket->updateAllFdTickets("toureast_fd");
        return response()->json(['success'=> true], 200);
    }
    ...
    public function getLatestTimeEntriesV3() {
            ...
            if(count($body) != 0) {
                ...
                foreach($time_entry_data as $key => $value) {
                    ...
                    if( ($len - 1) > $key && count($final_data) == 50) {
                        ...
                        $this->toureast_fd_time_entry->bulkDeleteById($ids);
                        $this->toureast_fd_time_entry->bulkInsert($final_data);
                        $final_data = [];
                        $ids = [];
                    }
        ...
        //die;
        $this->toureast_fd_time_entry->bulkDeletePreviousMonth($date_after,$date_on_or_before);
