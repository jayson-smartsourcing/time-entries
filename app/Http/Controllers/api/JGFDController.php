...
use App\JGFDGroup as JGFDGroup;
use App\JGFDCompany as JGFDCompany;
use App\JGFDAgent as JGFDAgent;
use App\JGFDContact as JGFDContact;
use App\JGFDTicket as JGFDTicket;
use App\JGFDTimeEntryV3 as JGFDTimeEntryV3;

class JGFDController extends Controller
{
    public function __construct(
        Guzzle $guzzle,
        BPNotFoundId  $bp_not_found,
        EmployeeRef $employee_ref,
        JGFDGroup $jg_fd_group,
        JGFDCompany $jg_fd_company,
        JGFDAgent $jg_fd_agent,
        JGFDContact $jg_fd_contact,
        JGFDTicket $jg_fd_ticket,
        JGFDTimeEntryV3 $jg_fd_time_entry
    )
    {
        $this->guzzle = $guzzle;
        $this->bp_not_found = $bp_not_found;
        $this->employee_ref = $employee_ref;
        $this->jg_fd_group = $jg_fd_group;
        $this->jg_fd_company = $jg_fd_company;
        $this->jg_fd_agent = $jg_fd_agent;
        $this->jg_fd_contact =$jg_fd_contact;
        $this->jg_fd_ticket = $jg_fd_ticket;
        $this->jg_fd_time_entry = $jg_fd_time_entry;
    }
    ...
    public function getAllGroups() {
        ...
        $this->jg_fd_group->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->jg_fd_group->bulkInsert($final_data);
            } 
    ...
    public function getAllCompanies() {
        ...
        $this->jg_fd_company->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->jg_fd_company->bulkInsert($final_data);
            } 
    ...
    public function getAllAgents(){
        ...
        $this->jg_fd_agent->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                $this->jg_fd_agent->bulkInsert($final_data);
            } 
    ...
    public function getAllTickets(){
        ...
        $this->jg_fd_ticket->truncateTable();
        ...
        for( $i = 1; $i<= $x; $i++ ) {
            ...
            if(count($body) != 0) {
                ...
                foreach($ticket_export_data as $key => $value) {
                    $now = Carbon::now();
                    $group = $this->jg_fd_group->getDataById($value->group_id);
    ...
    public function getAllTicketsV2(){
        ...
        $this->jg_fd_ticket->updateAllFdTickets("jg_fd");
        return response()->json(['success'=> true], 200);
    }
